 ...
 * @method static \Codedor\FilamentArchitect\BlockCollection forget(|array $keys)
 ...
 * @method static \Codedor\FilamentArchitect\BlockCollection||null pop(int $count = 1)
 ...
 * @method static \Codedor\FilamentArchitect\BlockCollection| random(callable|int|null $number = null, bool $preserveKeys = false)
 ...
 * @method static \Codedor\FilamentArchitect\BlockCollection||null shift(int $count = 1)
 ...
 * @method static \Codedor\FilamentArchitect\BlockCollection skipUntil(|callable $value)
 * @method static \Codedor\FilamentArchitect\BlockCollection skipWhile(|callable $value)
 ...
 * @method static \Codedor\FilamentArchitect\BlockCollection takeUntil(|callable $value)
 * @method static \Codedor\FilamentArchitect\BlockCollection takeWhile(|callable $value)
 ...
 * @method static \Codedor\FilamentArchitect\BlockCollection wrap(iterable| $value)
 ...
 * @method static \Codedor\FilamentArchitect\BlockCollection partition(callable||string $key, |string|null $operator = null, |null $value = null)
 * @method static mixed sum(callable|string|null $callback = null)
 * @method static \Codedor\FilamentArchitect\BlockCollection| whenEmpty(callable $callback, callable|null $default = null)
 * @method static \Codedor\FilamentArchitect\BlockCollection| whenNotEmpty(callable $callback, callable|null $default = null)
 * @method static \Codedor\FilamentArchitect\BlockCollection| unlessEmpty(callable $callback, callable|null $default = null)
 * @method static \Codedor\FilamentArchitect\BlockCollection| unlessNotEmpty(callable $callback, callable|null $default = null)
 ...
 * @method static \Codedor\FilamentArchitect\BlockCollection reject(callable|bool| $callback = true)
